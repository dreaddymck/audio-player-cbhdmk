		...
		<div class="options">
			<div class="pure-g controls" style="text-align: center">
				<div class="pure-u-1-4">
					<div class="play"  aria-hidden="true" title="Play">&#8250;</div>
				</div>
				<div class="pure-u-1-4">
					<div class="pause"  aria-hidden="true" title="Pause">&#215;</div>
				</div>
				<div class="pure-u-1-4">
					<div class="rew" aria-hidden="true" title="Back">&#171;</div>
				</div>
				<div class="pure-u-1-4">
					<div class="fwd"  aria-hidden="true" title="Forward">&#187;</div>
				</div>
			</div>			
		</div>			
	</div>
