    ...
    init: function(){
        ...
        jQuery("input[type='checkbox'][name='playlist_top_media']").on("click",function (e) {
            ...
            if( jQuery(this).prop("checked")){
                ...
                jQuery(".playlist_top_media_public").removeClass("hidden");
            }else{
                jQuery("li[data-tab='parent-tabs-2']").addClass("hidden");
                jQuery("li[data-tab='parent-tabs-8']").addClass("hidden");
                jQuery(".playlist_top_media_public").addClass("hidden");
            }
            if( jQuery("input[type='checkbox'][name='charts_enabled']").prop("checked") ||
