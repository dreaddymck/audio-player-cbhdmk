...
if (!class_exists("WPAudioPlayerCBHDMK")) {
	...
	class WPAudioPlayerCBHDMK {
		...
		function user_scripts() {
			...
			wp_enqueue_style( 'jquery-ui.min.css',  $this->plugin_url . "plugins/jquery-ui-1.11.4/jquery-ui.min.css");
			wp_enqueue_style( 'playlist.css',  $this->plugin_url . "playlist.css");
			
			wp_enqueue_script( 'jquery-ui.min.js', $this->plugin_url . 'plugins/jquery-ui-1.11.4/jquery-ui.js', array( 'jquery' ), '1.11.4', true );
